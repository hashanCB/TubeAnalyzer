...
export default function StreamingLanding() {
  return (
    (<div className="min-h-screen bg-[#0a0c10] text-white flex flex-col">
      {/* Hero Section */}
      <div
        className="flex-1 flex flex-col items-center justify-center px-4 py-12 space-y-8">
        ...
        <Button
          className="bg-[#4CAF50] hover:bg-[#45a049] text-white px-8 py-6 text-lg rounded-full">
          Go to Homepage
