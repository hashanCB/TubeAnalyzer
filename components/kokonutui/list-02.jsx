...
import { ArrowUpRight, ArrowDownLeft, Wallet, ShoppingCart, CreditCard, ArrowRight } from "lucide-react";
            ...
            <div
              ...
              <div className="flex-1 flex items-center justify-between min-w-0">
                ...
                <div className="flex items-center gap-1.5 pl-3">
                  <span
                    className={cn("text-xs font-medium", transaction.type === "incoming"
